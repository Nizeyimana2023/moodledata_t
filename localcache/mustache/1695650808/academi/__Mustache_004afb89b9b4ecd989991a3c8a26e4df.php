...
class __Mustache_004afb89b9b4ecd989991a3c8a26e4df extends Mustache_Template
{
...
';
        // 'logourl' section
        $value = $context->find('logourl');
        $buffer .= $this->section63667afd5138ceac58250d628c2fbbe7($context, $indent, $value);
        // 'logourl' inverted section
        $value = $context->find('logourl');
        if (empty($value)) {
...
';
    ...
    private function section63667afd5138ceac58250d628c2fbbe7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
